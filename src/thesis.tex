...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item V HexSpace grafu přidáme uzly pro každé vybrané sdílené vozidlo, plus hranu z hranu z počátečního uzlu do uzlu s vozidlem (s přidělenou váhou a módem chůze)
		\item V HexSpace grafu přidáme uzly pro stanice vozidel, plus hrany 
		\begin{itemize}
			\item z uzlu vozidla do uzlu docku (s přidělenou váhou a módem daného prostředku)
			\item z uzlu docku do konečného uzlu (s přidělenou váhou a módem chůze)
		\end{itemize}
		...
		\item vrátíme nejlepší základy tras,
	\end{itemize}
	...
	\end{itemize}
	\item K základům cest konkurentně spočítáme pěší etapy trasy. 
